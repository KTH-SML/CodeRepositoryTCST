...
class QualisysMapTfNode(object):
    def __init__(self):
        ...
        self.tf_qualisys_map.rotation.w = 0.0
        self.tf_qualisys_map.rotation.x = 0.0
        self.tf_qualisys_map.rotation.y = 0.358
        self.tf_qualisys_map.rotation.z = 0.934

        self.sub_qualysis_pose = rospy.Subscriber('nexus1/pose', PoseStamped, self.pose_cb)

        self.pub_map_pose = rospy.Publisher('nexus1/map_pose', PoseStamped, queue_size = 1)
    ...
    def pose_cb(self, msg):
        ...
        tf_br.sendTransform((M_pose_M_R.pose.position.x, M_pose_M_R.pose.position.y,M_pose_M_R.pose.position.z), (M_pose_M_R.pose.orientation.w, M_pose_M_R.pose.orientation.x, M_pose_M_R.pose.orientation.y, M_pose_M_R.pose.orientation.z), rospy.Time.now(), 'robot1/qualisys_odom', 'nexus1')
        #print('now')
    ...
    def convert_pose_from_frame1_to_frame2(self, pose, tf_frame1_to_frame2):
        ...
        trans_2_pose = quat_2_1 * (-trans_1_pose) * quat_2_1.inverse
        #print(trans_2_pose)
